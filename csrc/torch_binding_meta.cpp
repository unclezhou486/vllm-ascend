...
TORCH_LIBRARY_IMPL_EXPAND(CONCAT(_C, _ascend), Meta, ops) {
    ...
    ops.impl("npu_sparse_attn_sharedkv_v2", &vllm_ascend::meta::npu_sparse_attn_sharedkv_meta);
    ops.impl("npu_sparse_attn_sharedkv_metadata_v2", &vllm_ascend::meta::npu_sparse_attn_sharedkv_metadata_meta);
